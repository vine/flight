...
import import_registry from './registry';
import import_debug from './debug';
import import_advice from './advice';
import import_compose from './compose';
import import_base from './base';
import import_logger from './logger';
